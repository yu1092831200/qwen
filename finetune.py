...
class DataArguments:
    data_path: str = field(
        default="assets/data/data.json", metadata={"help": "Path to the training data."}
    )
    eval_data_path: str = field(
        default="assets/data/test.json", metadata={"help": "Path to the evaluation data."}
    )
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    use_lora: bool = True
    fix_vit: bool = True
    batch_size: int = field(default=1, metadata={"help": "Batch size per GPU/CPU for training."})
